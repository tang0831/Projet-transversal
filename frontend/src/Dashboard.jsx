...
import { 
  ...
  X, Printer, Download, Heart, Skull, PlusCircle
} from 'lucide-react';
import { getCitoyen, getActeNaissance, getActeMariage, getActeDeces, getProches, getListeActesDecesAccessibles } from './api';
...
export default function Dashboard() {
  ...
  // États pour les actes sélectionnés
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <button className="flex flex-col items-center gap-4 p-6 bg-white border border-gray-100 rounded-[1.5rem] hover:shadow-lg transition text-center group">
            ...
            <div className="flex-1 overflow-y-auto p-12 bg-[#FCFCFA]">
              <div className="text-center space-y-6">
                ...
                <div className="space-y-4 text-left">
                  ...
                  <div className="bg-white/50 p-4 rounded-2xl border border-gray-100">
                    <h4 className="text-xs font-black text-vert uppercase">Mentions Administratives</h4>
                    <p className="text-sm font-bold">Date de déclaration : {selectedActe.date_declaration}</p>
                    <p className="text-sm font-bold">Officier : {selectedActe.officier_etat_civil || 'RAKOTOMALALA Jean Pierre'}</p>
                  </div>
                </div>
              </div>
            </div>
