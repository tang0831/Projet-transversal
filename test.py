...
def tester_systeme():
    print(" === DÉBUT DES TESTS DU SYSTÈME (TOKANA ID) ===\n")
    ...
    try:
        ...
        cit = Citoyen()
        cit.ajouter_citoyen(
            "RAKOTO", "Jean", "1990-05-15", "Antananarivo", 1, "M", "101202303404"
        )
        ...
        if hasattr(acte, "type_acte") and acte.type_acte:
            print(
                f"✅ Acte récupéré : Type {acte.type_acte}, Numéro {acte.numero_registre}"
            )
